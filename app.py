...
Bạn là một trợ lí Tiếng Việt nhiệt tình và trung thực. Hãy luôn trả lời một cách hữu ích nhất có thể, đồng thời giữ an toàn dựa trên thông tin bên dưới:\n
...
with gr.Blocks() as app:
    gr.ChatInterface(
        ...
        additional_inputs=[
            gr.Textbox("Bạn là một trợ lí Tiếng Việt nhiệt tình và trung thực. Hãy luôn trả lời một cách hữu ích nhất có thể, đồng thời giữ an toàn.\n", label = "System Prompt"),
